...
The Teams Sync Action creates, updates, and deletes [New Relic Teams](https://docs.newrelic.com/docs/service-architecture-intelligence/teams/teams/)
based on team definition files stored in the GitHub repository against which
the action is run. A team definition file is a JSON file that contains the team
settings. All settings that can be defined for a team via the team related
mutations in the [Nerdgraph API](https://docs.newrelic.com/docs/apis/nerdgraph/examples/nerdgraph-teams-tutorial/)
...
The team name is derived from the name of the team definition file. For
example, to define a team named "Engineering", create a team definition file
named "Engineering.json".
...
**NOTE:** Currently, there is no way to specify the [authentication domain](https://docs.newrelic.com/docs/accounts/accounts-billing/new-relic-one-user-management/authentication-domains-saml-sso-scim-more/)
for a given email address. If a given email address exists in more than one
authentication domain within an [organization](https://docs.newrelic.com/docs/accounts/accounts-billing/account-structure/new-relic-account-structure/),
...
One or more custom [tags](https://docs.newrelic.com/docs/new-relic-solutions/new-relic-one/core-concepts/use-tags-help-organize-find-your-data/)
...
The tag names and values must conform to the [format and limits](https://docs.newrelic.com/docs/new-relic-solutions/new-relic-one/core-concepts/use-tags-help-organize-find-your-data/#tag-format)
...
```json
{
  ...
  "aliases": ["epd"],
  "members": ["fake-user-1@fake-domain-123.com", "fake-user-2@fake-domain-123.com"],
  "contacts": [
    {
      "type": "EMAIL",
      "title": "Test email",
